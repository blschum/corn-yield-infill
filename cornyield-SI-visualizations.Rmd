...
p <- ggplot(biophcv_preds, aes(x=YIELD, y=average_prediction)) +
  ...
  xlim(1,250) +
  ylim(0,250) +
  annotate("text", x = 175.0, y = 40.0, label = "RMSE = 16.4 bushels/acre\nVariance Explained = 82.6%", hjust=0)
p
...
p <- ggplot(reducedcv_preds, aes(x=YIELD, y=average_prediction)) +
  ...
  xlim(1,250) +
  ylim(0,250) +
  annotate("text", x = 175.0, y = 40.0, label = "RMSE = 17.1 bushels/acre\nVariance Explained = 81.0%", hjust=0)
p
