...
p <- ggplot(bioph_preds, aes(x=YIELD, y=average_prediction)) +
  ...
  xlim(1,250) +
  ylim(0,250) +
  annotate("text", x = 175.0, y = 40.0, label = "RMSE = 17.21 bushels/acre\nVariance Explained = 80.7%\nr = 0.90", hjust=0)
p
...
## Figure 6. Partial dependence plots for consistently important variables in the a) biophysical ensemble and b) farm(er) ensemble. Partial dependence is the dependence of the outcome on one predictor after averaging out the effects of all other predictors in the model (Cutler et al., 2007). Partial dependence plots graphically characterize the relationship between an individual predictor (standardized, here) and the predicted values of yield (see SI Figure 10A-F for unstandardized relationships).
...
ggsave("./viz/Figure6.png", dpi = 400, height = 400, width = 250,units="mm")
