...
>>>>>>> 43aab2b6db31cbcb79b38311a68dba962a8a037a
...
library(tidyverse)
# build full list of files and bring them into the R environment
prediction <- readRDS("./results/ranger-preds/bio_RFpreds_100.RDS")
...
library(tidyverse)
# build full list of files and bring them into the R environment
prediction <- readRDS("./results/ranger-preds/farmer_RFpreds_100.RDS")
